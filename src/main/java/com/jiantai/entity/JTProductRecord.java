...
public class JTProductRecord {
	...
	public String toString() {
		return "JTProductRecord [id=" + id + ", product=" + product + ", record_datetime=" + record_datetime
				+ ", datetime=" + datetime + ", unit=" + unit + ", yield=" + yield + ", company=" + company + "]";
	}
